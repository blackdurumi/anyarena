...
public class PostController {
    ...
    public ResponseEntity<PostLikersDto> getPostLikers(@PathVariable("postId") Long postId) {
        return ResponseEntity.ok(postApplication.getPostLikers(postId));
    }

    @PostMapping("/{postId}/like")
    public ResponseEntity<String> likeOrCancelPost(
        @RequestHeader("userId") Long userId, @PathVariable("postId") Long postId) {
        return ResponseEntity.ok(postApplication.likeOrCancelPost(userId, postId));
    }
}
